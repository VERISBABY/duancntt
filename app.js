(function () {
  ...
  const I18N = {
    ...
    'hero.eyebrow':      { en: 'Undergraduate IT Project · 2025–2026',
                           vi: 'Dự án Công Nghệ Thông Tin · 2025–2026' },
    ...
    'results.sub':       { en: 'Zero-shot baselines evaluated under identical Vietnamese prompts and greedy decoding. Our system is shown under beam-4 decoding; the greedy-decoding equivalent is reported above the fold.',
                           vi: 'Các baseline zero-shot được đánh giá với prompt tiếng Việt giống hệt và giải mã tham lam. Hệ thống của chúng tôi hiển thị dưới chế độ giải mã beam-4; phiên bản giải mã tham lam tương ứng được nêu ở phần trên.' },
